/**
 * Grid Variant - Blog List Template
 *
 * Professional 3-column grid layout with featured post.
 * Best for: 10-30 posts, general content sites
 */
        ...
        {hasFeaturedPost && (
          <section className="mb-16">
            <h2 className="mb-6 text-2xl font-bold text-foreground">
              {copy.sectionHeading || 'Featured Review'}
            </h2>
            <ArticleCard
              post={featuredPost}
              category={
