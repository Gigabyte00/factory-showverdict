/**
 * Masonry Variant - Blog List Template
 *
 * Pinterest-style column layout for visual density.
 * Best for: 50+ posts, image-heavy content sites
 */
...
export default function MasonryVariant({
  posts,
  categories,
  currentPage,
  totalPages,
